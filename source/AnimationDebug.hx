...
class AnimationDebug extends FlxState
{
	...
	override function create()
	{
		...
		if (isDad)
		{
			dad = new Character(100, 100, daAnim, false, true);
	...
	function genBoyOffsets(pushList:Bool = true):Void
	{
		...
		if (char.otherFrames != null)
		{
			for (i in char.otherFrames)
			{
				...
				{
					var anim = "";
					if (StringTools.contains(i.curCharacter,"left"))
						anim = "singLEFT";
					if (StringTools.contains(i.curCharacter,"up"))
						anim = "singUP";
					if (StringTools.contains(i.curCharacter,"down"))
						anim = "singDOWN";
					if (StringTools.contains(i.curCharacter,"right"))
						anim = "singRIGHT";
					var text:FlxText = new FlxText(10, 20 + (18 * daLoop), 0, anim + ": " + offsets, 15);
					text.scrollFactor.set();
					text.color = FlxColor.BLUE;
	...
	override function update(elapsed:Float)
	{
		...
		if (upP || rightP || downP || leftP)
		{
			...
			if (char.otherFrames != null)
			{
				...
				genBoyOffsets(false);
				var anim = "";
				if (StringTools.contains(char.otherFrames[curAnim].curCharacter,"left"))
					anim = "singLEFT";
				if (StringTools.contains(char.otherFrames[curAnim].curCharacter,"up"))
					anim = "singUP";
				if (StringTools.contains(char.otherFrames[curAnim].curCharacter,"down"))
					anim = "singDOWN";
				if (StringTools.contains(char.otherFrames[curAnim].curCharacter,"right"))
					anim = "singRIGHT";
				char.playAnim(anim);
			}
			else
